...
namespace OpusWrapper.Opus
{
    ...
    public class OpusEncoder : IDisposable
    {
        ...
        /// </summary>
        public SamplingRate InputSamplingRate { get; private set; }

        /// <summary>
        /// Gets the number of channels of the encoder.
        /// </summary>
        public Channels InputChannels { get; private set; }
        ...
        private OpusEncoder(IntPtr encoder, SamplingRate inputSamplingRate, Channels inputChannels, ApplicationType application)
        {
            _encoder = encoder;
        ...
        public static OpusEncoder Create(SamplingRate inputSamplingRate, Channels inputChannels, ApplicationType application)
        {
            IntPtr error;
            IntPtr encoder = Api.opus_encoder_create((int)inputSamplingRate, (int)inputChannels, (int)application, out error);
        ...
        public int FrameCount(byte[] pcmSamples)
        {
            ...
            int bitrate = 16;
            int bytesPerSample = (bitrate / 8) * (int)InputChannels;
